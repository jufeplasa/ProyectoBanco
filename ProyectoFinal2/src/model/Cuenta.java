...
/*
 * Comentario Julian
 * La clase Cuenta representa una cuenta con atributos basicos como aña actual, numero de cuenta
...
public class Cuenta extends Banco {
	...
	public String toString() {
		return "La cuenta "+numCuenta+" Con saldo "+saldo+"$ hace "+getFechaA()+" a�os\n";
	}
